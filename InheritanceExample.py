...
class Ogrenci(Kisi):
    def __init__(self,ad,soyad,yas,sinif,aldigi_ders_sayisi):
...
class Ogretmen(Kisi):
    def __init__(self,ad,soyad,yas,unvan,maas):
        super().__init__(ad,soyad,yas)
        self.unvan = unvan
        self.maas = maas
...
ogrenci = Ogrenci(None,None,None,None,None)
ogrenci.ad = input("Ad:")
...
ogretmen = Ogretmen(None,None,None,None,None)
