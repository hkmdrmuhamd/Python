...
def control_new_mac(interface):
    ...
    new_mac = re.search(r"\w\w:\w\w:\w\w:\w\w:\w\w:\w\w",ifconfig) #\w ile ifconfig yazinca gelen ether degerindeki mac adresinin degerini bulur
...
kontrol = control_new_mac(user_inputs.interface)
